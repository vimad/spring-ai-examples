...
import org.example.springaiexamples.question.GameRulesService;
...
@SpringBootTest(properties = {"spring.ai.openai.base-url=${openai.base.url}", "spring.ai.openai.api-key=123"})
public class SpringAiExamplesApplicationTests {
